...
AddEventHandler('esx_zipties:removeItem', function(item)
  ...
  TriggerClientEvent('esx:showNotification', _source, 'Du har brugt 1 ' .. item)
end)
...
AddEventHandler('esx_zipties:stealPlayerItem', function(target, itemType, itemName, amount)
	...
	if itemType == 'item_standard' then
		...
		if targetItem.count > 0 and targetItem.count <= amount then
			...
			if sourceItem.limit ~= -1 and (sourceItem.count + amount) > sourceItem.limit then
				...
				TriggerClientEvent('esx:showNotification', sourceXPlayer.source, 'Du stjal ' .. amount .. ' ' .. sourceItem.label .. ' fra ' .. targetXPlayer.name)
				TriggerClientEvent('esx:showNotification', 'En person ', '~b~' .. sourceXPlayer.source .. ' stjal ' .. amount .. ' ' .. sourceItem.label)
			end
		else
	...
	elseif itemType == 'item_account' then
		...
		TriggerClientEvent('esx:showNotification', sourceXPlayer.source, 'Du Stjal ' .. amount .. ' fra ' .. targetXPlayer.name)
		TriggerClientEvent('esx:showNotification', 'En person ', '~b~' .. sourceXPlayer.source .. 'stjal ' .. amount)
    ...
    targetXPlayer.removeWeapon(itemName)
		...
		TriggerClientEvent('esx:showNotification', sourceXPlayer.source, 'Stjal ' .. ESX.GetWeaponLabel(itemName) .. ' fra ' .. targetXPlayer.name)
		TriggerClientEvent('esx:showNotification', 'En person ', '~b~' .. sourceXPlayer.source .. ' stjal ' .. ESX.GetWeaponLabel(itemName))
	end
end)
